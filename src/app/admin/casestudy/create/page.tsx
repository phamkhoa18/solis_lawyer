  ...
  return (
    <TooltipProvider>
      <div className='flex flex-col gap-3'>
        ...
        >
          <h1 className="text-2xl font-bold text-gray-900 flex gap-3">Tạo Case Study Mới
        ...
        <Card className="shadow-md border border-gray-100 p-0">
              ...
              >
                <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                    ...
                    <div className="relative">
                        <Label htmlFor="slug" className="text-sm font-medium relative text-gray-700">
                            Slug (URL)
                        </Label>
                        <Input
                            id="slug"
                    ...
                    <div>
                        ...
                        >
                            ...
                            <SelectValue placeholder="Chọn danh mục" className='w-full' />
                            </SelectTrigger>
